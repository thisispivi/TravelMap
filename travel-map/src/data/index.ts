...
export const visitedTrips: Trip[] = [
  new Trip({
    ...
    origin: { city: Cagliari, transport: "plane" },
    returnTo: {
      city: Cagliari,
      transport: "plane",
      flight: { company: FlightCompany.EASYJET },
    },
    destinations: [
      {
        city: London,
        ...
        arrivalFlight: { company: FlightCompany.EASYJET },
      },
    ],
    route: [London.name],
  ...
  new Trip({
    ...
    returnTo: {
      city: Cagliari,
      transport: "plane",
      flight: { company: FlightCompany.RYANAIR },
    },
    destinations: [
      {
        city: Berlin,
        travelIdx: 0,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.RYANAIR },
      },
    ],
    route: [Berlin.name],
  ...
  new Trip({
    ...
    returnTo: {
      city: Cagliari,
      transport: "plane",
      flight: { company: FlightCompany.ITA_AIRWAYS },
    },
    ...
    destinations: [
      {
        ...
        travelIdx: 1,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.ITA_AIRWAYS },
        isLayover: true,
      },
      {
        city: Tokyo,
      ...
      { city: Osaka, travelIdx: 0 },
      {
        ...
        travelIdx: 1,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.ALL_NIPPON_AIRWAYS },
        isLayover: true,
      },
      {
        city: Rome,
  ...
  new Trip({
    ...
    route: [Verona.name, PeschieraDelGarda.name, Verona.name],
  ...
  new Trip({
    ...
    origin: { city: Alghero, transport: "plane" },
    returnTo: {
      city: Alghero,
      transport: "plane",
      flight: { company: FlightCompany.WIZZ_AIR },
    },
    destinations: [
      {
        city: Sofia,
        travelIdx: 0,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.WIZZ_AIR },
      },
  ...
  new Trip({
    ...
    returnTo: {
      city: Cagliari,
      transport: "plane",
      flight: { company: FlightCompany.AEROITALIA },
    },
    destinations: [
      {
        city: Rome,
        ...
        arrivalTransport: "plane",
        isLayover: true,
        arrivalFlight: { company: FlightCompany.AEROITALIA },
      },
      {
        city: Shanghai,
        travelIdx: 0,
      ...
      { city: Sydney, travelIdx: 0, arrivalTransport: "plane" },
      {
        city: Cairns,
        travelIdx: 0,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.JETSTAR },
      },
      {
        city: Sydney,
        travelIdx: 1,
        arrivalTransport: "plane",
        arrivalFlight: { company: FlightCompany.VIRGIN_AUSTRALIA },
      },
      {
        city: Shanghai,
        travelIdx: 0,
      ...
      { city: Rome, travelIdx: 0, arrivalTransport: "plane", isLayover: true },
    ],
    route: [Sydney.name, Cairns.name, Sydney.name],
  ...
  new Trip({
    ...
    origin: { city: PortoTorres, transport: "ferry" },
    returnTo: { city: PortoTorres, transport: "ferry" },
    destinations: [
      {
        city: Ajaccio,
        travelIdx: 0,
        arrivalTransport: "ferry",
        isLayover: true,
      },
      { city: Toulon, travelIdx: 0, arrivalTransport: "ferry" },
      { city: SaintTropez, travelIdx: 0 },
      { city: Nice, travelIdx: 0 },
      { city: MonteCarlo, travelIdx: 0 },
      { city: Cannes, travelIdx: 0 },
      { city: Toulon, travelIdx: 1 },
