 ...
 * @property {number} [bearing] - The bearing to the place from the record's origin
 * @property {City} city - The city to display
 * @property {number} [distanceKm] - The distance to the place from the record's origin
 ...
 * @param {number} [props.bearing] - The bearing to the place from the origin
 * @param {City} props.city - The city to display
 * @param {number} [props.distanceKm] - The distance to the place from the origin
  ...
  return (
    ...
    >
      ...
      <div className="city-card__content">
        ...
        {bearing !== undefined && distanceKm !== undefined ? (
          <p className="city-card__reading figure">
