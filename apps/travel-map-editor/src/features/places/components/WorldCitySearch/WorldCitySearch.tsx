...
import { useAnchoredMenu } from "../../../../shared/hooks/anchoredMenu";
import { searchWorldCities, WorldCity } from "../../lib/gazetteer";
    ...
    <div className="editor-field world-city-search">
      ...
      <div className="world-city-search__control" ref={controlRef}>
        <input
          ...
          {...getInputProps({
            placeholder: t("worldCitySearch.placeholder"),
          })}
        />
              ...
              <>
                ...
                {visible.length === 0 ? (
                  <li className="combobox__empty">
                    {term.trim().length < 2
                      ? t("worldCitySearch.typeAtLeastTwo")
                      : isLoading
                        ? t("worldCitySearch.searching")
                        : t("worldCitySearch.noMatchingCity")}
                  </li>
                ) : null}
              </>
            ) : null}
